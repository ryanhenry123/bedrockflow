...
from bedrockflow.evals.runwithevals import EvalLoopResult, MaxTurnsExceeded
from bedrockflow.evals.trace_io import write_run_artifact
...
def handle_run_failure(
    ...
    *,
    ...
    if trace:
        ...
        from bedrockflow.evals.runwithevals import EvalLoopResult
